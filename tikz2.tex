...
\tikzstyle{green vertex}=[circle,fill=darkgreen,minimum size=10pt]
...
%    % Start animating the vertex and edge selection. 
        ...
        \node<1->[red vertex] () at \pos{};
        \foreach \pos in { {(0,1)},{(2,2)},{(2,0)}}
        \node<1->[blue vertex] () at \pos{};
        \foreach \pos in { {(1,0)},{(2,1)}}
        \node<1->[green vertex] () at \pos{};
        \foreach \pos in { {(1,1)},{(2,-1)},{(3,1)}}
        \node<1->[grey vertex] () at \pos{};
